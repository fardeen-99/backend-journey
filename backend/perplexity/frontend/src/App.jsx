        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 shadow-2xl">
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              {/* Social Login */}
              {/* <button 
                className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-surface-container hover:bg-surface-container-high transition-all duration-300 border border-outline-variant/15 text-sm font-semibold tracking-tight group" 
                type="button"
              >
              ...
              {/* <div className="flex items-center justify-end">
                <a className="text-sm font-semibold text-secondary hover:text-secondary-dim transition-colors" href="#">Forgot password?</a>
              </div> */}

              {/* Primary CTA */}
              <button 
                className="w-full py-4 px-6 bg-primary-container text-on-primary-container font-bold rounded-xl shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 relative overflow-hidden group" 
                type="submit"
              >
            ...
            <div className="mt-8 text-center">
              <p className="text-on-surface-variant text-sm font-medium">
                ...
                <a className="text-secondary font-bold hover:underline underline-offset-4 ml-1" href="#">Sign Up</a>
              </p>
            </div>
          </div>
        </div>
