          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 shadow-2xl">
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="relative flex items-center justify-center">
                ...
                <span className="relative bg-transparent px-4 text-xs font-semibold text-outline tracking-widest uppercase">Register</span>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-on-surface-variant text-sm font-medium">
                ...
                <Link className="text-secondary font-bold hover:underline underline-offset-4 ml-1" to="/login">Sign In</Link>
              </p>
            </div>
          </div>
        </div>
